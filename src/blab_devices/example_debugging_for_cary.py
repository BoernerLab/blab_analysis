...
cary_analysis.redo_single_curve_fit("2023_08_31_DNA_TRIS-HCl_85_K", 1, melting_temp=np.array([335.15]), min_temp=30, max_temp=70, min_absorbance=30, max_absorbance=70)
